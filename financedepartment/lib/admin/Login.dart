...
import 'package:financedepartment/admin/signup.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget targetPage = financePage(); // Default to Homepage
  @override
  void initState() {
    super.initState();
  ...
  bool _verifyPassword(String inputPassword, String storedHashedPassword) {
    // Replace this with your hashing mechanism, e.g., bcrypt, SHA-256, etc.
    // For example, using bcrypt:
    // return bcrypt.checkpw(inputPassword, storedHashedPassword);

    // Placeholder: Insecure plain text comparison (for demonstration)
