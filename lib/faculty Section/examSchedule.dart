import 'package:faculty2/faculty%20Section/finalExam.dart';
...
Widget targetPage = examSchedule();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Exam Schedule",style: TextStyle(
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.center,
              ...
              children: [
                Padding(
                  ...
                  child: Text("List of Exam Typs",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'PLayfaair',fontSize: 25,),),
                ),
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final branches = ["Unit Test 1", "Unit Test 2", "Mid Sem", "Final"];
                    return GestureDetector(
                      onTapDown: (_) => _controller.forward(), // Press Animation
                      onTapUp: (_) => _controller.reverse(), // Release Animation
                      onTap: () {
                        targetPage = finalExam();
                        globalExamtyp = branches[index];
